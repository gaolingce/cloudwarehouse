...
if (!$conn)
    ...
    $sqlcount = "SELECT count(*) as count from outboundlist WHERE openid = '$openid' AND outboundDate BETWEEN '2019-01-01' AND '$today'";
    ...
    $sql = "SELECT outboundId,outbound_commodityName,outboundBag,outboundTotalprice,outboundDate,operationTime,outbound_commodityId,outboundBuyer FROM outboundlist WHERE openid = '$openid' AND outboundDate BETWEEN '2019-01-01' AND '$today' LIMIT $frontpage,$tag";
