...
if (!$conn)
    ...
    $sqlcount = "SELECT count(*) as count from outboundlist WHERE openid = '$openid' AND outboundDate BETWEEN '$begin' AND '$end'";
    ...
    $sql = "SELECT outboundId,outbound_commodityName,outboundBag,outboundTotalprice,outboundDate,operationTime,outbound_commodityId,outboundBuyer FROM outboundlist WHERE openid = '$openid' AND outboundDate BETWEEN '$begin' AND '$end' LIMIT $frontpage,$tag";
