...
if (!$conn)
    ...
    $sqlcount = "SELECT count(*) as count from inboundlist WHERE openid = '$openid' AND inboundlistDate BETWEEN '$lastmonth' AND '$today'";
    ...
    $sql = "SELECT inboundlistId,inboundlist_commodityName,inboundlistBag,inboundlistAmount,inboundlistDate,operationTime,inboundlist_commodityId FROM inboundlist WHERE openid = '$openid' AND inboundlistDate BETWEEN '$lastmonth' AND '$today' LIMIT $frontpage,$tag";
