...
if (!$conn)
    ...
    $sqlcount = "SELECT count(*) as count from inboundlist WHERE openid = '$openid' AND inboundlistDate BETWEEN '$begin' AND '$end'";
    ...
    $sql = "SELECT inboundlistId,inboundlist_commodityName,inboundlistBag,inboundlistAmount,inboundlistDate,operationTime,inboundlist_commodityId FROM inboundlist WHERE openid = '$openid' AND inboundlistDate BETWEEN '$begin' AND '$end' LIMIT $frontpage,$tag";
